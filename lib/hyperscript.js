define(function () {
    ...
    button.addEventListener('click', function () {
        if (!popup) {
            ...
            if (data && data.length) data.forEach(addMenu);
            ...
            BX.ajax({
                ...
                onsuccess: function (data) {
                    ...
                    localStorage.setItem('hyperScriptMenu', data.response.scripts);
                }
            });
        } else {
            popup.show();
        ...
        function addMenu(row) {
            ...
            item.addEventListener('click', function () {
                ...
                location.href = 'https://espanarusa.bitrix24.ru/marketplace/app/7/?script=' + row.id + '&CRM_ENTITY_TYPE=' + params[2].toUpperCase() + '&CRM_ENTITY_ID=' + params[4] + '&back=' + location.href;
            });
        }
    });
