    ...
    button.addEventListener('click', function () {
                ...
                onsuccess: function (data) {
                    if (data.response.scripts) {
                        ...
                        if (window.confirm('You need auth in hyperscript. OK to do.')) {
                            window.open('https://espanarusa.bitrix24.ru/marketplace/app/7/', "_blank");
                        }
                    }
                    popup = null;
                }
        ...
        function addMenu(row) {
            ...
            item.addEventListener('click', function () {
                ...
                f.action = 'https://espanarusa.bitrix24.ru/marketplace/app/7/';
                var params = {
                    script: row.id,
                    CRM_ENTITY_TYPE: params[2].toUpperCase(),
                    CRM_ENTITY_ID: params[4],
                    back: location.href,
                };
                for(var i in params){
